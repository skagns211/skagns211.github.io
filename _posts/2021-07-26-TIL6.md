 ...
 **``text-align: ``** <br>
 -> 텍스트 정렬 속성. left, center, right를 입력해 텍스트를 좌측, 중앙, 우측으로 정렬할 수 있다.<br>
 
**``color: ``** <br>
-> 글자 색을 바꾸는 속성. 원하는 색상의 이름(ex. red, green) 또는 색상 코드를 입력해 바꿀 수 있다.<br>
...
**``font-weight: nomar | bold | bolder | lighter | number | initial | inherit``** <br>
...
**``margin-left: 40px;``** <br>
-> 위와 같이 각각에 특정할 수도 있음. (음수값을 넣으면 다른 element와 겹치게 할 수도 있음)<br>
